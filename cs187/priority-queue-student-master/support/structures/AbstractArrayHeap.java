...
public abstract class AbstractArrayHeap<P, V> {
	 ...
	 */
	private final ArrayList<Entry<P, V>> heap;
	 ...
	 * @return The modifie d{@link AbstractArrayHeap}
	 * @throws NullPointerException
	...
	public final AbstractArrayHeap<P, V> add(P priority, V value) {
		if (priority == null || value == null)
			throw new NullPointerException(
					"priority and value must be non-null.");
	...
	public final V peek() {
		if (heap.isEmpty())
			throw new NoSuchElementException(
					"Cannot peek at an empty ArrayHeap.");
	...
	public final V remove() {
		if (heap.isEmpty())
			throw new IllegalStateException(
					"Cannot remove from an empty ArrayHeap.");
