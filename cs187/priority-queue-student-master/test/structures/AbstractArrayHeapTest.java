...
public class AbstractArrayHeapTest {
	...
	public void setup() {
		assertNotNull(
				"It looks like you didn't set which implementaiton of AbstractArrayHeap to use in your configuration file.",
				Configuration.getArrayHeap(new StringLengthComparator()));
		arrayHeap = Configuration.getArrayHeap(new StringLengthComparator());
	}
	...
	@Test (timeout = 100)
	public void testBubleUpAndBubbleDown(){
		// The comparator being used prioritizes by the length of the string
				// passed in as a priority
